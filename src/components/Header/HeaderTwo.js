...
const { navItems, title, logo7, logo6, zacologo } = headerData;
...
const HeaderTwo = ({ headerStyle = "mainmenu-six", header = 6 }) => {
  ...
  return (
    <nav
      className={`${headerStyle} main-header${scrollTop ? " fixed-header" : ""
        }`}
    >
      <div className="auto-container">
        <div className={`${headerStyle}__inner nav-outer`}>
          ...
          <div>
            <Image src={logo6.src} width={118} alt={title} />
          </div>
          ...
          <nav className="main-menu navbar-expand-md navbar-light">
            ...
            >
              <ul className="navigation clearfix" style={{color:"white"}}>
          ...
          {header === 6 ? (
            <div className="mainmenu-six__right">
              ...
              {/* <Link href="/">
                <div className="thm-btn__six mainmenu-six__btn">
                  Get a Free Quote
                </div>
              </Link> */}
            </div>
